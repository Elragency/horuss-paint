...
var define_ASTRO_INTERNAL_I18N_CONFIG_default = { base: "/", format: "directory", site: "https://horuss.ca", trailingSlash: "ignore", i18n: { defaultLocale: "fr", locales: ["en", "fr"], fallback: { en: "fr" }, routing: { prefixDefaultLocale: false, redirectToDefaultLocale: true } }, isBuild: true };
