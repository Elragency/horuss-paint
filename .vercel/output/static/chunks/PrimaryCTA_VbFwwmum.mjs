...
const $$PrimaryCTA = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const bgColorClasses = "bg-indigo-700 hover:bg-orange-400 active:bg-indigo-900 dark:focus:outline-none";
...
}, "/Users/goon/Desktop/ELR-Agency/ELR-Agency/ELR Agency Clients/horuss-paint/src/components/ui/buttons/PrimaryCTA.astro", void 0);
